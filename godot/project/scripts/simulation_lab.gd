...
const FIELD_LABELS := {
    ...
    "ecology.soil_carbon_kg": "LAB_FIELD_SOIL_CARBON",
    "ecology.soil_fast_carbon_kg": "LAB_FIELD_FAST_SOIL_CARBON",
    "ecology.soil_slow_carbon_kg": "LAB_FIELD_SLOW_SOIL_CARBON",
    "ecology.heterotrophic_respiration_kg_day": "LAB_FIELD_SOIL_RESPIRATION",
    "ecology.soil_respired_carbon_kg": "LAB_FIELD_SOIL_RESPIRATION_TOTAL",
