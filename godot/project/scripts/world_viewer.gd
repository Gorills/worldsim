...
const MOUNTAIN_DEMO_SPAWN_EAST_M := 5_586_750.0
const MOUNTAIN_DEMO_SPAWN_NORTH_M := -1_810_300.0
const MOUNTAIN_DEMO_TARGET_EAST_M := 5_589_250.0
const MOUNTAIN_DEMO_TARGET_NORTH_M := -1_809_675.0
