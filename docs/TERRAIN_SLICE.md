...
correction introduces epoch 23. The current reader therefore rejects global
snapshot versions 2 through 22; the preceding history through epoch 22 is
retained to show which terrain-era states they contain.
