...
deposition return N to mineral fields. Cumulative leaching and fire-emission
fields remain audit histories and are excluded from the planetary stock to
avoid double counting. Focus LOD therefore cannot create or destroy global N.
See `NITROGEN_CYCLE.md`.
