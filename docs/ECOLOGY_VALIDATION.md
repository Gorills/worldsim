...
- historical epoch-20 soil-carbon snapshots round-tripped and continued
  deterministically; the current combined world uses epoch 27.
...
- the current epoch-27 snapshot includes the fauna-respiration ledger, rejects
...
- snapshot epoch 27 round-trips authoritative fire, soil-carbon, fauna-carbon
